...
<div class="container mt-2">
    <div class="card">
        <div class="card-header">
            <a href="{{route('inspection.storage')}}">Общий список</a>
        </div>
        <div class="card-body">
            <div class="row">
                @foreach($lists as $list)
                    <div class="col-md-2 col-sm-1">
                        @if($isMain)
                            <a href="{{route('inspection.storage', ['name' => $list])}}" class="color-black">
                                <img src="/images/folder.png" width="50" height="50" alt="">
                                <span>{{ $list }}</span>
                            </a>
                        @else
                            <div class="mb-2 font-size-0_7">
                                <img src="{{$list['url']}}" width="100" height="80" alt="">
