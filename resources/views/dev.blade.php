    ...
    <div class="main_margin flex-row width100">
        @switch($type)
            ...
            <div class="p-4 d-flex justify-content-center w-100">
                <div>
                    <img src="/images/development/boss.jpg" style="width: 80%;">
                </div>
            </div>
            @break
            @case('company')
            <div class="p-4 d-flex justify-content-center w-100">
                <div>
                    <img src="/images/development/company.jpg" style="width: 80%;">
                </div>
            </div>
            @break
            @case('rating')
            <div class="p-4 d-flex justify-content-center w-100">
                <div>
                    <img src="/images/development/rating.jpg" style="width: 80%;">
                </div>
            </div>
            @break
            @case('results')
            <div class="p-4 d-flex justify-content-center w-100">
                <div>
                    <img src="/images/development/results.jpg" style="width: 80%;">
                </div>
            </div>
            @break
            @case('study')
            <div class="p-4 d-flex justify-content-center w-100">
                <div>
                    <img src="/images/development/study.jpg" style="width: 80%;">
                </div>
            </div>
            @break
            @default
