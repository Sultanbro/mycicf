<div class="col-md-2 blocks-small-borderRad-top blocks-small-borderRad-bot box-shadow padding0 mt-3 mb-3">
    ...
    <div class="mb-5">
        <ul class="flex-column mr-3 ml-3">
            ...
            @if(in_array(auth()->user()->dept_isn, \App\User::getMotivationDepartments()) || in_array(auth()->user()->ISN, \App\Kurators::getActiveUsers()) || auth()->user()->ISN == 3560197 || auth()->user()->ISN == 1445721 || auth()->user()->ISN == 235472 || auth()->user()->ISN == 5011 || auth()->user()->ISN == 4275866 || auth()->user()->ISN == 766502 || auth()->user()->ISN == 3534147 || auth()->user()->ISN == 801271)
