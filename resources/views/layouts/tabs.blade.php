<div class="flex-row mt-3 vertical-middle">
    ...
    @if(in_array(\App\Branch::getParentId($ISN), \App\User::getMotivationDepartments()) && (!in_array(\App\Branch::getParentId($ISN),["3994433", "3994439", "3436136"])) || auth()->user()->ISN == 5011 || auth()->user()->ISN == 4275866 || auth()->user()->ISN == 766502)
