<template>
    <div>
        <div>
            <span>Удалить сенткоины за 2019-2020 г.</span>
            <div class="flex justify-content-center form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                <button type="button" @click="spendAll" class="btn-info btn-lg btn">Удалить</button>
            </div>
        </div>
        <div>
            <form action="">
...
<script>
    export default {
        ...
        methods : {
            ...
            spendAll() {
                this.axios.post('/centcoins/spendCoinAll', {}).then((response) => {
