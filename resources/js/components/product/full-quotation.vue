<template>
    <div>
        ...
        <div class="col-md-12 mb-4 mt-4">
            <div class="row">
                <div class="col-md" v-for="(participant,index) in participants">
        ...
        <div  class=" div-ml div-marg div-mr">
            <div class="  agreement-block " >
                <div v-for="attribute in attributes" class=" col-md-8  " style="width:95%;">
                    <agr-attributes :attribute="attribute" :express-attr="expressAttr" :calc-changed="calcChanged" :preloader="preloader"></agr-attributes>
                </div>
            </div>
        </div>
