<template>
    ...
    <div class=" marg-l  text-hw">  <!--class="col-12 row mt-2 mb-2 ml-0  h-auto"-->
        ...
        <div class="row ">
            ...
            <div v-if="agrobject.ClassISN != ''" class="col-lg-4 col-xl-4 col-md-6 col-sm-6 col-12 mt-0">
            ...
            <div v-if="agrobject.ClassISN != ''" class="col-12 ">
                <div class="col-md-8" v-if="Object.keys(agrobject.objekt[agrobject.ClassISN].AGROBJCAR).length > 0">
            ...
            <div v-if="agrobject.ClassISN != ''" class="col-8"> <!-- Атрибуты объекта -->
                <div class="col-12 ">
                    <agr-attributes
