<template>
    <div class="nav d-flex justify-content-center bg-white">
        <div class="nav-container flex-row w-100">
            <div class="row width110">
                <div class="blue-bg-all w-100">
                    <div class="flex-row w-100 jc-center">
                ...
                <div class="nav-dropdown initial" v-if="isOpened">
                    <div class="nav-dropdown__container mt-5">
<!--                        <button type='button'-->
<!--                                class="close-btn"-->
<!--                                @click="showDropdown">-->
...
<!--                        </button>-->
                        <div class="dropdown-content mb-4 flex-row" >
                            ...
                            <!--Column 2-->
                            <div class="dropdown-content__inner pr-4 pb-4 w-100 d-flex" >
                                <div class="w-100">
                                ...
                                <div v-if="levelOneOpened" class="border border-primary p-2 d-flex dropdown-content__inner-list w-100 bg-white justify-content-between flex-column">
                                    ...
                                    <div class="m-2 d-flex min-height-15"
                                        ...
                                        <img :src="innerItem.icon_url"
                                             class="items-icons">
                                        <span>
                                            <a :href="'/productsinfo/'+innerItem.url+'?id='+levelOnePinned">{{innerItem.label}}</a>
                                        </span>
                                    </div>
                                </div>
