...
//        'DeptName' => 'подразделение',
//        'DutyName' => 'должность',
        'Rentability' => 'отношение дохода от продаж к доходу по страховой деятельности',
        ...
        'VtsShare' => 'доля договров ОСГПО ВТС с физ. лицами без учета договров с нерезидентами в портфеле(% высчитывается от кол-ва)',
        ...
        'CrossShare' => 'Заключение договора с одним клиентом более чем по одному классу страхования',
