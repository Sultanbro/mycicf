...
COMISSIONSUM,
translate(remark, CHR(10)||CHR(13)||'/|\-', '      ') remark,
fid, updated,updatedby, parentisn, limitsumtype, paymentkoeff,
premiumsumtariff, created, createdby, reasoncancelisn, previsn
from inslab.agrcond 
where updated > to_date('$updated','dd.mm.YYYY HH24:MI:SS')";
    }
...
UPDATED,UPDATEDBY,ACCIDENTMODEISN,CREATED,CREATEDBY,
TIMECLAIM,SCHEMEISN,
